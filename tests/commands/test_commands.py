...
@patch('invenio_cli.commands.commands.run_proc')
@patch('invenio_cli.commands.commands.DockerHelper')
def test_shell(p_docker_helper, p_run_proc, mock_cli_config):
...
@patch('invenio_cli.commands.commands.run_proc')
@patch('invenio_cli.commands.commands.DockerHelper')
def test_pyshell(p_docker_helper, p_run_proc, mock_cli_config):
...
@patch('invenio_cli.commands.commands.run_proc')
@patch('invenio_cli.commands.commands.DockerHelper')
def test_destroy(p_docker_helper, p_run_proc, mock_cli_config):
    commands = Commands(mock_cli_config, p_docker_helper())
    commands.destroy()

    p_run_proc.assert_called_with(['pipenv', '--rm'], check=True)
